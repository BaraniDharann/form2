...
public class game {
	...
	private void winningGame() {
		if(b1==1 && b2==1 && b3==1) {
			JOptionPane.showMessageDialog(frame,"player x Wins","game",JOptionPane.INFORMATION_MESSAGE);
			xCount1++;
		...
		// for 0 player//
		if(b1==0 && b2==0 && b3==0) {
			JOptionPane.showMessageDialog(frame,"player o Wins","game",JOptionPane.INFORMATION_MESSAGE);
			oCount1++;
		...
		if(b7==0 && b8==0 && b9==0) {
			JOptionPane.showMessageDialog(frame,"player o Wins","game",JOptionPane.INFORMATION_MESSAGE);
			oCount1++;
			oCount.setText(String.valueOf(xCount));
			}
		if(b1==0 && b4==0 && b7==0) {
			JOptionPane.showMessageDialog(frame,"player o Wins","game",JOptionPane.INFORMATION_MESSAGE);
			oCount1++;
	...
	private void initialize() {
		...
		btnEXIT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent agr0) {
				...
				if(JOptionPane.showConfirmDialog(frame,"Confirm you want Exit "," tia toc game",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
				{
					System.exit(0);
				}
			}
